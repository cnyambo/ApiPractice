 ...
 */
      async function searchShows(query) {
        ...
        // hard coded data.
            ...
            {
                arr.push(response.data[id].show);
      ...
      async function getEpisodes(id) {
       ...
       // https://api.tvmaze.com/shows/1/episodes
        ...
        for( let id = 0; id<rows; id++)
        {
            ...
            episodes.push(response.data[id]);
      ...
      function populateEpisodes(episodes) {
        ...
        for (let episode of episodes) {
          ...
          let $item = $(
            `  <li class="card-text">Name: ${episode.name}, Season:${episode.season}, Number:${episode.number}, Summary:${episode.summary} </li>
